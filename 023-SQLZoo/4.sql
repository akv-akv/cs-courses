/* SQLZoo Part 4 - SELECT within SELECT */
...
SELECT name FROM world WHERE ifnull(gdp,0) >
...
FROM world w1
WHERE name <= ALL
(SELECT name FROM world w2 WHERE w1.continent = w2.continent)
